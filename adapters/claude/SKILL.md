...
GENERATED by `loupe render-adapters` from one source (review/adapters.py) at tool version 0.8.0 — do not edit; regenerate. `loupe render-adapters --check` guards it.
