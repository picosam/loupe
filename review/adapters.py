...
def procedure() -> dict:
    ...
    "author": [
        ("write the claim",
         ...
         f"of strings; the rest are strings; required: "
        ...
        ("hand off",
         ...
         "the same envelope. `--debug` stamps the round as a debug round: "
         "the reviewer is asked to also critique the tool's own "
         "performance this round (efficiency, cost, accuracy) in a `## "
         f"{vocab.TOOL_FEEDBACK_SECTION}` verdict section, recorded at "
         "close — advisory, never a gate. THEN STOP: hand the human the fenced block "
